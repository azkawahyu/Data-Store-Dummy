      ...
      <div className="emp-del-overlay" onClick={onClose}>
        <div className="emp-del-modal" onClick={(e) => e.stopPropagation()}>
          <div className="emp-del-header">
            ...
            <div>
              <p className="emp-del-title">Hapus Pegawai</p>
              <p className="emp-del-desc">
                Anda akan menghapus{" "}
                <span className="emp-del-name">{employee.nama}</span> (
                {employee.nip}). Tindakan ini tidak dapat dibatalkan.
              </p>
            </div>
          </div>
